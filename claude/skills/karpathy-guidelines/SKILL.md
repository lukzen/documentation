...
description: Andrej Karpathy's 12 guidelines for LLM-assisted coding. Invoke at the start of any coding task — writing or editing code, fixing bugs, refactoring, or reviewing — to enforce think-before-coding, simplicity, surgical changes, goal-driven execution, reading before writing, intent-based tests, checkpointing, convention-matching, and failing loud. Use when the user references "Karpathy rules/guidelines" or asks for disciplined coding behavior.
---
